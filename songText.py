...
# print(f"Você disse: {text}"): Imprime o texto reconhecido na linha anterior na tela.
    # O "f" indica que é uma string formatada e as chaves {} são usadas para incluir as variáveis ou expressões dentro da mensagem. Quando a mensagem é exibida, o valor da variável "text" é inserido no local onde as chaves estão colocadas.
